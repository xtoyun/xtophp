    ...
    m.events = {
        ...
        theme: function() {
            ...
            m.strToWin(h(this).data("window")).layui.admin.popupRight({
                id: "layer-theme",
                type: 2,
                content: n ? n : "/admin.php/admin/index/theme"
            })
        },
        note: function() {
            var n = h(this).data("url");
            m.strToWin(h(this).data("window")).layui.admin.popupRight({
                ...
                type: 2,
                closeBtn: false,
                content: n ? n : "/admin.php/admin/index/note"
            })
        },
        message: function() {
            var n = h(this).data("url");
            m.strToWin(h(this).data("window")).layui.admin.popupRight({
                id: "layer-notice",
                type: 2,
                content: n ? n : "/admin.php/admin/index/message"
            })
        },
        psw: function() {
            var n = h(this).data("url");
            m.strToWin(h(this).data("window")).layui.admin.open({
                ...
                area: ["420px", "300px"],
                shade: 0,
                content: n ? n : "/admin.php/admin/account/password"
            })
        },
        logout: function() {
            var n = h(this).data("url");
