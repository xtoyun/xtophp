...
CREATE TABLE `xto_about` (
  ...
  `nid` int(11) unsigned zerofill DEFAULT NULL,
...
-- ----------------------------
-- Table structure for xto_download
-- ----------------------------
DROP TABLE IF EXISTS `xto_download`;
CREATE TABLE `xto_download` (
...
-- ----------------------------
-- Table structure for xto_icase
-- ----------------------------
DROP TABLE IF EXISTS `xto_icase`;
CREATE TABLE `xto_icase` (
...
-- ----------------------------
-- Table structure for xto_member_bank
-- ----------------------------
DROP TABLE IF EXISTS `xto_member_bank`;
CREATE TABLE `xto_member_bank` (
  `mbid` int(11) NOT NULL AUTO_INCREMENT,
  `realname` varchar(255) DEFAULT '',
  `bankname` varchar(255) DEFAULT '',
  `bankaccount` varchar(255) DEFAULT '',
  `bankaddress` varchar(255) DEFAULT '',
  ...
  `iscenter` bit(1) DEFAULT b'0',
  PRIMARY KEY (`mbid`)
) ENGINE=InnoDB AUTO_INCREMENT=10003 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for xto_member_refers
-- ----------------------------
...
-- ----------------------------
-- Table structure for xto_message_note
-- ----------------------------
DROP TABLE IF EXISTS `xto_message_note`;
CREATE TABLE `xto_message_note` (
...
-- ----------------------------
-- Table structure for xto_order_service
-- ----------------------------
DROP TABLE IF EXISTS `xto_order_service`;
CREATE TABLE `xto_order_service` (
...
CREATE TABLE `xto_product` (
  ...
  `spec` varchar(1000) DEFAULT '0' COMMENT '规格',
...
-- ----------------------------
-- Table structure for xto_product_service
-- ----------------------------
DROP TABLE IF EXISTS `xto_product_service`;
CREATE TABLE `xto_product_service` (
...
-- ----------------------------
-- Table structure for xto_product_specs
-- ----------------------------
DROP TABLE IF EXISTS `xto_product_specs`;
CREATE TABLE `xto_product_specs` (
  `spid` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `specs` varchar(255) DEFAULT NULL,
  `price` decimal(18,4) DEFAULT NULL,
  `m_price` decimal(18,4) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for xto_rewark_service
-- ----------------------------
DROP TABLE IF EXISTS `xto_rewark_service`;
CREATE TABLE `xto_rewark_service` (
  `rsid` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `mstart` int(11) DEFAULT '0',
  `mend` int(11) DEFAULT '0',
  `appid` int(11) DEFAULT '0',
  `create_time` int(11) DEFAULT NULL,
  `update_time` int(11) DEFAULT NULL,
  `bili` smallint(18) DEFAULT NULL,
  `img` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`rsid`)
...
-- ----------------------------
-- Table structure for xto_solution
-- ----------------------------
DROP TABLE IF EXISTS `xto_solution`;
CREATE TABLE `xto_solution` (
