...
class FormTemplate  extends Template{
    ...
    public function addLabel($name = '', $title = '', $tips = '', $default = '', $attr = [], $extra_attr = '', $extra_class = '',$script='')
    {
        $item = [
            'type'        => 'label',
            'name'        => $name,
    ...
    public function submit($a='',$action='',$url=''){
        if ($action=='') {
            $v=empty($a)?$this->action:$a;
            if($url==''){
                $this->setData('submit',"return app.submit(this,'$v');");
            }else{
                $this->setData('submit',"return app.submit(this,'$v','$url');");
            } 
            $this->setData('action','');
        }else{
            $this->setData('submit','');
    ...
    public function btntext($txt){
        $this->setData('btntext',$txt);
        return $this;
    }
}