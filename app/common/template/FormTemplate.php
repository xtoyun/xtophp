...
class FormTemplate  extends Template{
    ...
    public function addColor($name = '', $title = '', $tips = '', $default = '', $group = [], $extra_attr = '', $extra_class = '',$script='')
    {
     ...
     public function addParas($name = '', $title = '', $tips = '', $default = '', $group = [], $extra_attr = '', $extra_class = '',$script='')
    {
        $item = [
            'type'        => 'paras',
            'name'        => $name,
    ...
    public function addCkeditor($name = '', $title = '', $tips = '', $default = '', $size = '', $ext = '', $extra_class = '',$script='')
    { 
        $item = [
            'type'        => 'ckeditor',
            'name'        => $name,
    ...
    public function addLediter($name = '', $title = '', $tips = '', $default = '', $size = '', $ext = '', $extra_class = '',$script='')
    { 
        $item = [
            'type'        => 'lediter',
            'name'        => $name,
