	...
	public function index(){
		...
		return $this->template
				...
				->setColumns([
	                ...
	                ['email', '邮件'], 
	                ['mobile', '手机'],
	                ['points', '积分','link',url('asset.point/index').'/userid/$userid'], 
	                ['wallets', '钱包','link',url('asset.wallet/index').'/userid/$userid'],
	                ['splittins', '奖金','link',url('asset.splittin/index').'/userid/$userid'],
	                ['realname', '姓名'],
